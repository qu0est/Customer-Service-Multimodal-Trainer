            ...
            for key, value in message.items():
                ...
                if key == "text" and value:
                    ...
                    if not is_safe:
                        ...
                        feedback = f"Content flagged: {safety_message}"
...
def _make_chatbot() -> gr.Chatbot:
    """Create a Chatbot component compatible with Gradio 4.x through 6.x."""
    import gradio
    ...
    # Gradio 4/5 uses show_copy_button and type; Gradio 6 uses buttons and removed type
    if major >= 6:
        kwargs["buttons"] = ["copy"]
    else:
    ...
    # Set legacy attributes so tests that inspect these attributes still pass
